...
import com.example.javaapi.common.ZKCommonUtils;
...
public class TestZookeeperAuth implements Watcher {
    ...
    public void createConnection(String connectString, int sessionTimeout) {
        ZKCommonUtils.releaseConnection(this.zk);
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("使用授权key:" + correctAuthentication + "创建的接节点：" + PATH + "初始化内容是：init content");
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//        testAuth.releaseConnection();
        ZKCommonUtils.releaseConnection(zk);
    }
