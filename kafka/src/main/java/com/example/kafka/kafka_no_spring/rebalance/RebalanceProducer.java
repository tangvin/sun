...
public class RebalanceProducer {
    ...
    private static DemoUser makeUser(int id) {
        ...
        String userName = "我是实体设置的userName_id=" + id;
    ...
    public static void main(String[] args) {
        KafkaProducer<String, String> producer =
                new KafkaProducer<String, String>(KafkaConst.producerConfig(StringSerializer.class, StringSerializer.class));
        try {
            for (int i = 0; i < MSG_SIZE; i++) {
                DemoUser demoUser = makeUser(i);
                ProducerRecord<String, String> record =
                        new ProducerRecord<String, String>(BusiConst.REBALANCE_TOPIC, null,
